...
class DnaSeqRaw(common.Illumina):
    ...
    The standard GenPipes DNA-Seq pipeline uses BWA to align reads to the reference genome. Treatment
    ...
    A summary html report is automatically generated by the pipeline with MultiQC. Various Quality Control (QC) 
