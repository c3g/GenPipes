...
do
  ...
  then
    perl -pi -e 'undef $/; s#----\n(\w*):\n#----\n```\n![workflow diagram]('$diagram_folder_path'GenPipes_'$pipeline'_$1.resized.png)\n```\n$1:\n#g' `dirname "$script"`/README.md
  else
    perl -pi -e 'undef $/; s#Steps:\n------\n#Steps:\n```\n![workflow diagram]('$diagram_folder_path'GenPipes_'$pipeline'.resized.png)\n```\n------\n#g' `dirname "$script"`/README.md
  fi
done
...
perl -pi -e 'undef $/; s#----\n(\w*):\n#----\n```\n![workflow diagram]('$diagram_folder_path'GenPipes_hicseq_$1.resized.png)\n```\n$1:\n#g' pipelines/hicseq/README.md
