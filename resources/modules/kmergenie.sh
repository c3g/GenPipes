...
VERSION="1.5692"  ## TO BE MODIFIED WITH e.g. 2.2.28+, 3.0, 0.1.19, etc.
...
mv -i $SOFTWARE-$VERSION.tar.gz $MUGQIC_INSTALL_HOME/archive  ## TO BE MODIFIED WITH SPECIFIC $SOFTWARE-$VERSION.(zip|tar.gz|tar.bz2) IF DIFFERENT
