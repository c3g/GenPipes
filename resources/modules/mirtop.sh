...
ARCHIVE_URL=https://github.com/miRTop/${SOFTWARE}/archive/refs/tags/v${VERSION}.tar.gz
...
build() {
  ...
  pip install --prefix=$INSTALL_DIR/$SOFTWARE_DIR --ignore-installed git+https://github.com/miRTop/${SOFTWARE}.git@v${VERSION}
