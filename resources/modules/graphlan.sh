...
ARCHIVE_URL=https://github.com/biobakery/${SOFTWARE,,}/archive/refs/tags/$VERSION.tar.gz
...
build() {
  ...
  pip install --prefix=$INSTALL_DIR/$SOFTWARE_DIR --ignore-installed ${SOFTWARE,,}==${VERSION}.1
