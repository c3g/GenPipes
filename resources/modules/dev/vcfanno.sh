...
ARCHIVE_URL="https://github.com/brentp/vcfanno/releases/download/v$VERSION/$SOFTWARE""_linux64"
...
build() {
  cd $INSTALL_DOWNLOAD
	...
	chmod a+x  "$SOFTWARE""_linux64"
	mkdir $SOFTWARE_DIR
  cp "$SOFTWARE""_linux64" $SOFTWARE_DIR/$SOFTWARE
