...
SOFTWARE="genemark-s"
VERSION="4.30"
ARCHIVE="genemark_suite_linux_64.tar.gz"
ARCHIVE_URL="http://topaz.gatech.edu/GeneMark/tmp/GMtool_y9U2C/$ARCHIVE"
...
build() {
  ...
  mv genemark_suite_linux_64 $SOFTWARE_DIR

  wget http://topaz.gatech.edu/GeneMark/tmp/GMtool_y9U2C/gm_key_64.gz -O gm_key_64.gz
	gunzip gm_key_64.gz
...
prepend-path    PATH                \$root/gmsuite
set            home                 \$::env(HOME)
file delete \$home/.gm_key
file copy       $INSTALL_DIR/$SOFTWARE_DIR/gmsuite/gm_key \$home/.gm_key
"
}
