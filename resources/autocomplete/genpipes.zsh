...
_shtab_genpipes_commands() {
  local _commands=(
    "ampliconseq:Version\: 5.0.0"
    "chipseq:Version\: 5.0.0"
    "covseq:Version\: 5.0.0"
    "dnaseq:Version\: 5.0.0"
    "methylseq:Version\: 5.0.0"
    "nanopore:Version\: 5.0.0"
    "nanopore_covseq:Version\: 5.0.0"
    "rnaseq:Version\: 5.0.0"
    "rnaseq_denovo_assembly:Version\: 5.0.0"
    "rnaseq_light:Version\: 5.0.0"
  )
...
Default is genpipes\/ressources\/container\/bin\/container_wrapper.sh. This is a convenience options for using genpipes in a container]:wrap:"
  ...
  {-d,--design}"[design file]:design_file:"
  "(- : *)"{-v,--version}"[show the version information and exit]"
  {-t,--type}"[Type of pipeline (default chipseq)]:protocol:(bismark hybrid dragen)"
)
