...
pacBioAssemblyCeleraConfig.pl \\
  ...
  > {outfile}""".format(
        infile=infile,
        meryl_threads=global_config_parser.param('pacbio_tools_celera_config', 'meryl_threads', param_type='int'),
        ovl_threads=global_config_parser.param('pacbio_tools_celera_config', 'ovl_threads', param_type='int'),
        overlapper=global_config_parser.param('pacbio_tools_celera_config', 'overlapper'),
        mer_compression=global_config_parser.param('pacbio_tools_celera_config', 'mer_compression'),
        mer_size=mer_size,
        meryl_memory=global_config_parser.param('pacbio_tools_celera_config', 'meryl_memory'),
        ovl_error_rate=global_config_parser.param('pacbio_tools_celera_config', 'ovl_error_rate', param_type='float'),
        ovl_min_len=global_config_parser.param('pacbio_tools_celera_config', 'ovl_min_len', param_type='int'),
        frg_min_len=global_config_parser.param('pacbio_tools_celera_config', 'frg_min_len', param_type='int'),
        ovl_store_memory=global_config_parser.param('pacbio_tools_celera_config', 'ovl_store_memory', param_type='int'),
        ovl_concurrency=global_config_parser.param('pacbio_tools_celera_config', 'ovl_concurrency'),
        ovl_corr_concurrency=global_config_parser.param('pacbio_tools_celera_config', 'ovl_corr_concurrency', param_type='int'),
        cns_concurrency=global_config_parser.param('pacbio_tools_celera_config', 'cns_concurrency', param_type='int'),
        frg_corr_threads=global_config_parser.param('pacbio_tools_celera_config', 'frg_corr_threads', param_type='int'),
        stop_after=global_config_parser.param('pacbio_tools_celera_config', 'stop_after'),
        unitigger=global_config_parser.param('pacbio_tools_celera_config', 'unitigger'),
        outfile=outfile
    ))
