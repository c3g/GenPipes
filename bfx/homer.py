...
findHiCCompartments.pl \\
  ...
  > {fileName_Comp}""".format(
            ...
            res=res,
            genome=genome,
            cpu=config.param("identify_compartments", "threads", param_type='posint'),
...
annotateInteractions.pl \\
  ...
  {fileName_anno}""".format(
            ...
            cpu=config.param("identify_peaks", "threads", param_type='posint')
        )
    )
...
findMotifsGenome.pl \\
  ...
  -p {threads}""".format(
            ...
            genome=genome,
            output_dir=output_dir,
            threads=config.param('homer_find_motifs_genome', 'threads', param_type='posint')
        ),
