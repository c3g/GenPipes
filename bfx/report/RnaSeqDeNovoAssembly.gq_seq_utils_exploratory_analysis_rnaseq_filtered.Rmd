...
Different exploratory data analysis (EDA) techniques are applied to isoform expression levels, quantified  
...
hierarchical clustering on the log2(CPM) isoform expression levels. The Ward method is applied 
to the matrix of Pearson's correlation distance.

Secondly, we perform principal component analysis (PCA) on isoform expression levels (log2CPM). 
...
second-largest variability. These two components are usually sufficient to differentiate groups of 
samples describing the principal effects of the experimental design.
