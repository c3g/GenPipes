...
```{r temp_setup}
params$input <<- "~/scratch/job_output"
params$output <<- NA
...
parsed_folder <- function(folder_path_list){
  ...
  for (i in file_path_list){
	...
	#List_values <- c("JobName", "00:00:00", "00:11:00", "00:22:00", 3, 4, 5)
      }
...
saveRDS(Info_df, file = "Info_df.rds")
datatable(Info_df)
...
#if(!is.na(Keep_hour(DF_plot$WaitingTime))){
