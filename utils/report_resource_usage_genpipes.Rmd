...
parsed_folder <- function(folder_path_list){
  ...
  for (i in file_path_list){
    ...
    for (j in i){
      ...
      FileInput = scan(j ,sep="\n",what="char(0)",nlines=5000, quiet = TRUE)
...
Values_SLURM <- function(FileInput_List){
  ...
  # out_JobName <- tryCatch(
  #   {
  #     
  #     return(JobName)
  #     
  #   },error = function(cond){
  #      #case where JobName isn't found, meaning job get cancelled and .o file doesn't have the same structure
  #      return(NA)
  #   }
  # )
...
#scheduler choosed  params$scheduler
