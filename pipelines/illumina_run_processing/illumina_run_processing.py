 ...
 --fastq-cluster-count 0""".format(
    ...
    def align(self):
        """
            ...
            "library_source" is cDNA or contains "RNA"; otherwise BWA_mem is used to align 
            the reads.
        """
        jobs = []
    ...
    def generate_documentation(self):
        """ Utility method to create a markdown compatible readme file """
        print("# Illumina Run Processing Pipeline\n\n")
        print("Version: " + self.version + "\n\n")

        print("## Overview\n")
        print(textwrap.dedent(self.__doc__).replace("_", "\\_") + "\n")
        ...
        for idx, step in enumerate(self.steps):
            print("### Step " + str(idx+1) + ": " + step.__name__.replace("_", "\\_") + "\n")
            print(textwrap.dedent(step.__doc__).replace("_", "\\_") + "\n")
