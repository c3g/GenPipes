...
optional arguments:
  ...
  -r READSETS, --readsets READSETS
                        readset file
  -t {bismark, hybrid, dragen} --type PROTOCOL - methylation alignment method 
                        (default bismark) 
...
--------------------------
Retrieve the computed metrics which fit the IHEC standards and build 
a tsv report table for IHEC. 

Note: The dragen protocol does not generate a 
metric for estimated library size. You will have to run Picard seperately for this
metric
...
To create combined CSV CpGs should be extracted from the dragen 
methylation report.
