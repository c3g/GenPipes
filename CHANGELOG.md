41 tags, 9862 commits

HEAD        Thu Jul 20 13:18:33 2023 -0400        89 commits

  ehenrion <edouard.henrion@mcgill.ca>      2 commits

       5dc6ac8 Merged in dovee_multiqc (pull request #414)
       24f8c8f DOvEE - set multiqc_inputs as a pipeline attribute and make changes accordingly

  mareike.janiak@computationalgenomics.ca <mareike.janiak@computationalgenomics.ca>      77 commits

       df08b45 Version bump to 4.3.3
       6a2e154 DOvEE : update job2json to work with dovee user
       a8d140f Genpipes dovee : update main README
       386226d GenPipes dovee : add README
       03850c7 GenPipes dovee : cleaning up old comments
       dc28a03 GenPipes dovee : update filepaths in ini
       1cc87e8 cleaning up
       01a9d91 bfx : add missing output file to locatit
       cf82e8d DOvEE : added parsing of locatit and creak output metrics, added to multiqc
       22a18b4 DOvEE : changed options for multiqc and bcftools_stats in ini
       6d46406 DOvEE : add parsing of creak metrics, picard gcbias metrics to pipeline
       616abca DOvEE : add picard collect gcbias metrics to ini, add multiqc options
       7e15695 bfx picard2 : fixed typo in collect_gcbias_metrics - qcbias = gcbias
       e243f8f bfx agent : add stats file to expected creak outputs
       67161bd DOvee : add creak and subsample sections to ini
       9f0a8e7 dovee : add creak dedup and samtools subsample steps
       caee1e3 bfx : add creak to agent wrapper
       c0ee656 dovee : add sample source to symlink names for multiqc display
       0caca75 dovee : change mosdepth bed file used
       7a5287a DOvEE : add bam matching step with conpair to that samples are from same patient
       40d46af Merge branch 'DOvEE_genpipes_Sflag' into DOvEE_genpipes
       f18819e DOvEE : modified bwa mem settings in ini
       32f21dd DOvEE : add option to picard HS metrics to ignore validation errors
       732ebae DOvEE : use sorted locatit output to side step sort error
       8621850 DOvEE : update multiqc to look for symlink inputs in one directory, set order of modules in report
       d04276f DOvEE : change multiqc job dependencies to run even if jobs fail
       8c6cecd DOvEE : multiqc inputs changed to directories to avoid error with failed samples
       3adb81c DOvEE : fix error in trimmed read symlink creation
       829ff3c DOvEE : add --interactive option to multiqc to prevent flat plots
       7dbc140 DOvEE : fix bed files used for mosdepth
       7cf8ad0 DOvEE : add readset level directories to mapping step
       20a7fdd DOvEE : add tmp directory to samtools sort
       e9dc801 DOvEE : make files executable
       7e2daa4 DOvEE : remove -K flag from locatit call to avoid keeping tmp files
       7f32db9 DOvEE vardict : add bcftools stats step
       210429f DOvEE : add bcftools stats to vardict protocol
       d440122 cleaning up, fixing indents, copyrights
       eac8909 dovee : cleaning up and adding comments
       54cd4c4 adding copyright sections
       01913ce dovee : added option to distinguish between brush and saliva via modified version of design file
       841ae37 small dovee ini fixes
       adb834e add output file to mosdepth
       ecd7b09 created dovee sample pair parser based on tumor pair system
       b9b8f34 adding multiqc
       eed1438 dovee samtools sort : changed to avoid restart errors
       bd3c654 dovee metrics : add picard HS metrics
       a398406 dovee : added metrics steps
       8764ebb mosdepth : fixed typo
       4f0edd4 trimmer : edits to STATS rm command
       2a21115 trimmer : changed mv to ln to prevent job restarts
       dda4c1b dovee : adjust resources
       4f6a428 dovee ini : ichor version change, other small fixes
       5e3db81 ichorCNA : fixed typo
       8333851 dovee : merge sort & index steps, update sort to look for inputs from previous jobs, add hybrid dedup for copy-number protocol
       cebe94f dovee ini : add/fix filepaths
       e3a2fe4 vardict : add module call for vardict_single
       74431a8 dovee small fixes
       6579f70 dovee resource and other ini updates
       95eb543 samtools merge : change module call and add other_options
       eed26dd hmm : add module call
       cd9d0ea tweaked job names to be consistent with ini
       4cea397 updating resources and filepaths
       0d1da04 dovee : add bam merge to allow for top ups
       4214630 ichorCNA : removed # from module call
       dc9aa5d bwa mem : remove single end option
       2e60edb update bwa options, update agent calls
       de382e3 combine trimmer and locatit into single agent script
       cc53452 trimmer and locatit updates now that modules are installed
       3935a13 DOvEE : add placeholder wig file paths
       08a0c45 DOvEE : fixing small errors
       7c697e2 DOvEE : add init
       7bb7402 fixed small errors and indentation throughout
       4789437 fixed indentation
       3b0fe90 moved comment
       c7f7345 fixes in pipeline and ini for new dovee pipeline
       f9495d5 new trimmer trimming function added
       912643e new locatit dedup function added

  Mareike Janiak <mareike.janiak@computationalgenomics.ca>      9 commits

       3c7f0b4 adding fastp.py from run_processing branch to dovee
       6b549b3 mosdepth : add to genpipes
       9f2ae20 trimmer : remove STATS file if already exists
       84a8ff7 DOvEE : add tumor pair pairing system
       27a4d74 DOvEE : add pairs file option
       9db0a25 GenPipes DOvEE : add copy number protocol to pipeline
       921ca32 GenPipes DOvEE : add hmm and ichorCNA sections to ini
       41bb80d GenPipes DOvEE : create script for ichorCNA
       f8fdbb4 GenPipes DOvEE : create script for hmm readCounter

  Mareike Janiak <mjaniak@bouvardia.genome.mcgill.ca>      1 commits

       0394c20 DOvEE pipeline : first commit

4.4.2        Wed Jun 21 15:59:13 2023 +0000        204 commits

  Edouard Henrion <edouard.henrion@mcgill.ca>      43 commits

       cf60298 Utils - added dump_ChangeLog.sh in utils
       2c745e1 DNASeq - removed `sed` call in manta_sv_calls command
       80ecce8 Tumor Pair - Fix run_pair_multiqc job name
       2f31d6b Tumor Pair - fix multiqc step
       a20dfc8 Tumor Pair - Fixed multiqc step dependencies
       98aac8e RNASeq - Fixed multiqc step dependencies
       8172a2a DNASeq - Fixed multiqc step dependencies
       58dfc13 DNASeq - Fix gcbias output deps for multiqc
       187a10c HiCSeq - updated mugqic_tools to 2.12.1 to fix hicrep
       9fdf08e Core - Job : fix report_files in concat_jobs
       a5f1fbb GenPipes - updated dates in licence
       352863a Tumor Pair - Updated multiqc prep steps and job
       f83b6e9 DNASeq - stop index bams with picard_mark_duplicates, now using sambamba index instead to create bam.bai files
       f265ce3 RNASeq - Fix rnaseqc2 call : now uses sambamba to index the .bam as .bam.bai instead of picard creating .bai
       b19bfb0 Tumor Pair - Fixing MultiQC jobs in cases of missing dependencies
       db6c00e RNASeq - cancer : Updated pcrg version to 1.0.3
       51ea7fd BFX - fixed jsonator update
       5f89f78 Utils - remove JSON file when empty
       876ad39 Tumor Pair - updated bam input selecton for manta_sv and gatk_variant_annotator steps
       c175aef RNASeq - varianats/cancer : update docstring for merge_vcfs step
       ea76e9d RNASeq - varinats/cancer : updated merge_hc_vcf removing contigs/super contigs when merging vcf
       7258e70 RNASeq - variants/cancer : allow gatk_indel_realigner step to be skipped
       31ddad7 DNASeq / Tumor Pair - Picard SamToFastq : improved passing of resource parameters
       e09c760 Resources - updated SMRTLink install script with latest version
       9bbaf26 Tumor PAir - fixed typo in gripss wrapper
       fe29ad4 Version bump to 4.3.2
       ca99865 Merge remote-tracking branch 'origin/dev' into release_4.3.2
       a34fda4 Core - Scheduler : corrected `memory` call in `cpu` from dev
       80afe6d Version bump to 4.3.1
  ...
  ehenrion <edouard.henrion@mcgill.ca>      77 commits
       ...
       f7b553c Resources - Updating Conpair and Mugqic_Tools installation scripts with latest versions
       f592c03 Merged in multiqc_cit_fix (pull request #427)
       b824427 HiCSeq - updated mugqic_tools to 2.12.0 to use the fixed version of hicrep.R (for no down-sampling cases)
       2e15b7f Merged in update_licence (pull request #422)
       4d8e1f5 RNASeq - fixed rnaseqc2 output dependencies
       fdfb9b4 Modules - Updated binary wrapping done by installation scripts
       369653a Modules - Added bamixchecker installation script
       171a744 Module - Updated mugqic_tools.sh with latest version
       a1d73e3 Utils - fixed watch_portal_folder for some cases with empty json : stop throwing error and remove the json instead
       4b8c7bd Resources - AGeNT : fixed typo in module
       dcdd181 fix typo
       fcc76d8 GenPipes - improving job2json
       a458c39 GenPipes - strengthening the jsonator
       f869fdc Tumor Pair - refining resources assigned to gridss_paired_somatic jobs
       a6e9a3b Merge branch 'dev' of bitbucket.org:mugqic/genpipes into dev
       a756c81 Tumor Pair - Fixed inputs for "sequenza.create_seqz" jobs
       3d9b5c0 Tumor Pair - fix linx_plot output dependency to avoid useless restart of the step
       55ceb6d HiCSeq - RobusTAD : fixed output name to fix restart issue
       b1d7edc Utils - made mugqicValidator.py Python3-compatible
       59f2a41 Tumor Pair - fixed gatk4.ini for cobalt, amber and purple
       5ed67ce Tumor Pair - fixed gripss.py arguments in bfx
       6d511de Tumor Pair - fixed settings for mutect2 when using gatk4
       1a0c106 Core - Add details to some sanity check error messages
       2419d27 RNASeq - fixed stringtie-merge dependencies
       47cf66a Merged in tumor_pair_dependency_fix (pull request #413)
       acd6976 Tumor Pair - Fixed gripss calls
       6793fdf Version bump to 4.4.2-beta
       f40eae0 Merged in release_4.4.1 (pull request #412)
       e9cd38b Version bump to 4.4.1
       0d2e78f Merged in release_4.4.1 (pull request #411)
       412c2e3 GenPipes - in prep for bug-fix release 4.4.1
       c27edf1 Resources - update mosdepth version to 0.3.3 in install script
       6a5222f EpiQC - correcting chromimpute_preprocess command : do not use "rm" and force symlink creation with the "-f" flag
       087fd9b Resources - adding / updating install scripts
       252b6ee RNASeq Light - Added mkdir to the kalliso command
       07f45a2 Resources - adding 'gget' install script and updating others
       ed8e359 Version bump to 4.4.1-beta
       20c470b Merged in release_4.4.0 (pull request #410)
       8cabdc1 Version bump to 4.4.0
       1c29476 Merged in release_4.4.0 (pull request #409)
       bc80668 Merge branch 'dev' of bitbucket.org:mugqic/genpipes into release_4.4.0
       468975c updating README
       b0db9b9 Merge branch 'dev' of bitbucket.org:mugqic/genpipes into release_4.4.0
       67fe5bb RNASEq Light - Fixed Kallisto step
       9e01417 Resources - added HMMcopy package in defaults R libraries
       ffd223d RNASeq Light - Adding kallisto wrapper in bfx
       91bca69 RNASeq Light - revamping the call to Kallisto to have per gene counts instead of per readset
       d83071d Resources - Adding install script for hmmcopy-utils and ichorCNA
       79b74d0 Resources - Adding AGeNT install script and updating script for VarDict
       d2a8fef RNASeq Denovo Assembly - fixed trinity job dependencies
       9629f9a RNASeq Light - removing kallisto output folder before runnig kallisto to avoid mixed or bad results in case of pipeline restart
       eb7df8b EpiQC - fixed signal_to_noise dependencies
       48f936c DNASeq High Coverage - increased default walltime for gemini_annotations
       43121ea HiCSeq - fixing "homer_tag_directory" outputs
       4f7bfea Merge remote-tracking branch 'origin/dev' into release_4.4.0
       cf28289 GenPipes - updating READMEs before release
       70d27f7 Resources - Adding some new install scripts
       699683c Resources - updated version in some install scripts
       3d0c96d EpiQC - improved restart mechanisms
       aa742e3 Merged in release_4.3.2 (pull request #389)
       ed7c183 Merged in release_4.3.2 (pull request #388)
       118309c Merged in release_4.3.1 (pull request #383)
       baeee47 Merged in release_4.3.1 (pull request #382)
  ...
  mareike.janiak@computationalgenomics.ca <mareike.janiak@computationalgenomics.ca>      14 commits
       ...
       43767b8 Genpipes : methylseq - clarifying multiqc comment
       df70dbf GenPipes : methylseq - update mkdir commands
       9614d14 GenPipes : methylseq - add comments to explain multiqc options
       918d8ac bfx : dragen.py - add report_files to outputs
       1ce1781 bfx : dragen.py - extend outputs to avoid list within list
       2da1c94 GenPipes : methylseq - change automatic sample naming for trimmomatic multiqc
       60baae9 GenPipes : methylseq ini add multiqc options
       8961e31 GenPipes : methylseq - ihec table to multiqc format
       04d0de1 GenPipes : methylseq - add multiqc to bismark align
       3bdff14 bfx : make sambamba options ini section not required
       f2b9ccb GenPipes methylseq : add multiqc to pipeline
       37608f3 GenPipes methylseq : add symlink_dragen_metrics section to ini
       776f679 GenPipes methylseq : add multiqc to base ini
       97ba46e bfx : add metrics files to expected dragen output and report files

  Mareike Janiak <mareike.janiak@computationalgenomics.ca>      66 commits

       485c806 Merged in release_4.4.2 (pull request #430)
       ed55718 Merge remote-tracking branch 'origin/dev' into release_4.4.2
       8888ad0 update pipeline READMEs prior to release
       b1c1389 Merged in methylseq_multiqc (pull request #429)
       15780ff Merged in trimmomatic_multiqc (pull request #428)
       b2387dc GenPipes : add symlink for trimmomatic log to use with multiqc
       5a068a9 GenPipes methylseq : increase mem for filter_snp_cpg step in cit
       9f728b7 Merged in rm_hard_clip (pull request #426)
       a0b2122 GenPipes tumor_pair : loop over report_files output for multiqc symlinks
       1850d23 bfx : add report_files output to picard metrics
       8726b5c GenPipes tumor_pair : multiqc - add sample name to qualimap symlinks
       271b96e GenPipes : rm sequencing_center refs to wrong centre, add underscores to McGill_Genome_Centre
       7eb52d4 GenPipes rnaseq : rm bam_hard_clip step
       f40ed17 GenPipes : rm wrong sequencing centre, add underscores to McGill_Genome_Centre
       5c6fe1c Merged in cit_multiqc_fixes (pull request #424)
       621b0f6 Genpipes methylseq : increased mem for bissnip and filtering steps during cit
       4b739b5 GenPipes tumor_pair : cleaned up commented out and unnecessary lines
       03c3e8a GenPipes epiqc : add mkdir to chromimpute convert step
       6e1c874 Genpipes tumor_pair : fix path for is_gz file check
       68baa95 GenPipes tumor_pair : remove unnecessary os.mkdir call
       0eae1f9 Genpipes tumor_pair : create multiqc report dir as part of jobs
       859c1cc GenPipes tumor_pair : fix multiqc symlink creation for qualimap outputs
       8ee7b43 Merged in rnaseq_multiqc (pull request #423)
       21db3e9 GenPipes rnaseq : multiqc module order
       1128cb7 GenPipes rnaseq : fix relative path for input of rseqc.tin step
       477a689 bfx : rm abspath in input for rseqc.tin
       cd04bf4 GenPipes rnaseq : fixed interactive option for multiqc in ini
       f448b92 GenPipes rnaseq : fixed symlink in run_arriba, change dependency exit status for multiqc
       916d36d GenPipes rnaseq : fixed symlink in run_arriba
       efd63a1 GenPipes rnaseq : merged and resolved conflict with dev
       13ab19d GenPipes rnaseq : fix symlink relative path
       8fb9e18 GenPipes rnaseq : make multiqc interactive
       ba66e8b GenPipes rnaseq : fixed symlink names for multiqc inputs
       70db420 GenPipes rnaseq : removed stray commas, fixed typos
       30ce092 GenPipes rnaseq : removed stray comma
       c56ce40 GenPipes rnaseq : fix job name
       e851d87 GenPipes rnaseq : fixed another relative path command
       c02906b GenPipes rnaseq : added missing link directory assignment
       b1796d8 GenPipes rnaseq : fixed relative path command
       451dbf4 GenPipes rnaseq : added missing parenthesis
       d92e260 GenPipes rnaseq : added missing comma
       eae40ef GenPipes rnaseq : add multiqc section to base ini
       97a255f GenPipes rnaseq : add multiqc to pipeline
       9481206 bfx : add log files to expected output for multiqc integration
       baa0813 Merged in tp_ensemble_fix (pull request #421)
       72b3853 GenPipes tumor_pair : add remove command before bcbio_ensembl call to avoid silent error when output exists
       70b3e16 Merged in chipseq_blacklist_filter (pull request #418)
       63d8fe7 Chipseq : add blacklist path to ini
       02a2c73 Merged in readme_updates (pull request #417)
       1d18f5e GenPipes chipseq : update README to include blacklist filtering step
       6ac8485 GenPipes chipseq : added input selection to cram, variant calling steps
       5e3f613 GenPipes chipseq : fix inputs for diffbind and run_spp depending on blacklist removal step
       2c510bd bfx differential_binding : add option to specify alignment file extension
       b6cbc84 GenPipes chipseq : fixed various typos, add multiqc inputs
       86f54ef GenPipes chipseq : add blacklist and bedtools module to base ini
       30bc6ff GenPipes chipseq : fixed typo
       3660c64 GenPipes chipseq : add bedtools intersect step to pipeline, add ini section
       45093bb GenPipes chipseq : add bedtools intersect to remove blacklist reads prior to peak calling
       b6fb946 GenPipes : improved README for dnaseq pipeline
       f47ca3a Merged in Mareike-Janiak/commonpy-edited-online-with-bitbucket-1681414777818 (pull request #416)
       bc8ecef common.py edited online with Bitbucket - fix for sambamba merge dependency
       420681f Merged in sambamba_merge_fix (pull request #415)
       be8788f GenPipes common : simplified rm command before sambamba_merge
       d6b84fb GenPipes common : add comments to rm command before sambamba merge
       05957e7 Common : sambamba_merge_sam_files fix typos
       f45b830 Common sambamba_merge_sam_files : remove any existing file/link before merge
...
4.4.0        Thu Mar 9 18:24:15 2023 +0000        156 commits
  ...
  Edouard Henrion <edouard.henrion@mcgill.ca>      24 commits
       ...
       afb8ae7 RNASeq - Fix arriba inputs
       18fb041 RNASeq - fixing Arriba inputs and dependencies
       f4913ea RNASeq - Set the default build back to GRCh37
       658004c EpiQC - Fixing `chromimpute_convert` dependency with `chromimpute_preprocess`
       222c9d9 GenPipes - Resources : updated java and nextflow installation scripts
       be0334b GenPipes - Resources : some fixes in install_genome.sh
       77071b2 GenPipes - Linting + multiqc dependency stengthening
       efeb906 Minor update : just removing trailing comma
       039fef2 GenPipes - MultiQC : updated all the multiqc call with latest MultiQC version and removed the loading of Python module
       28943fc HiCSeq - corrected typo
       8095f0f RNASeq - Adding 'cancer' and 'variants' protocols + removing 'cufflinks' protocol
       0ba1053 BFX - Linx : minor formating updates
       d33db13 Tumor Pair - SV : correcting purple.py after rebase
       7e462a3 Tumor Pair - SV : revamping SV protocol of Tumor Pair with use of amber, purple, gridss, etc...
       5efad86 BFX - Conpair : corrected rm command
       d9b7605 Tumor Pair - fixed typo in filename
       7074e10 Tumor Pair - fixes qualimap inputs to multiqc
       483a1c3 Tumor Pair - updating multiqc to 1.14
       26ac4f1 Tumor Pair - update inputs to multiqc
       aad32e3 Tumor Pair - Strengthening the depedencies for the multiqc reports
       2321290 BFX - MultiQC : removed python module from command
       ada37b0 Tumor Pair - corrected multiqc dependencies
       ec00387 Tumor PAir - Adding Compair and Purple to multiqc call
       fe29ad4 Version bump to 4.3.2
  ...
  ehenrion <edouard.henrion@mcgill.ca>      49 commits
       ...
       699683c Resources - updated version in some install scripts
       3d0c96d EpiQC - improved restart mechanisms
       dc3822f RNASeq - Arriba : updated path of 'blacklist', 'known_fusions' and 'protein_domains' annotation files for GRCh37 in rnaseq.base.ini
       1eef454 Merged dev into cit_fixes_mcj
       925fa89 Nanopore CoVSeq - minor linting update
       6f4b9a9 EpiQC - fixed file path : distinction between files for job dependency and files for direct access
       d69696e GenPipes - resources : added ceratits_capitata.EGII-3.2 install script + version update in java.sh and picard.sh
       f9ca3c1 Tumor_pair - corrected java19 module
       07f2bfd PCGR report - added 'ls' command on the html report output to confirm job success
       991a65d Fixed mark_duplicate calls in all pipelines being from picard or gatk + Fixed pcgr report argument order in tumor_pair
       b6a2923 GenPipes - RNASeq : correctied calls to gatk_mark_dupliates + fixed arriba annotations for b38
       691ba5b GenPipes - Tumor Pair : updating cit.ini for GRCh37 default
       582055e GenPiopes - RNASeq : fixed picard/gatk_mark_duplicate
       362b724 Merge branch 'dev' of bitbucket.org:mugqic/genpipes into dev
       c5c436a RNASeq - Stringtie : updating resources for picrad mark duplicates
       0cec83c RNASeq - Fixing sym link in star_align
       7faa99a GenPipes - resources : update of GRCh38 install scripts
       9edf7b5 Resources - modules : adding pandas to the default python libraries
       bccb703 Merged in tpsv (pull request #401)
       598e4c3 Resources - version updates for bcftools, htslib, samtools, python3 and multiqc
       fc5d59f Adding 'core/__pycache/' to .gitignore
       317283e EpiQC - minor change in chromimpute
       834752e Resources - Genome : updated 'create_bwa_index' with sym links to .fai and .dict
       aad898f Merged in tp_fix_multiqc (pull request #399)
       74f7b45 Merged dev into tp_fix_multiqc
       6017946 RNASEQ - Wiggle : corrected deeptools call
       1f444bc Merged dev into Gerardo_rnaseq_bigwig
       fd2b64a Merged in hotfix_dev (pull request #391)
       f64dc2b DNASEQ - ensemble_metasv dependency fix
       94efcdb GenPipes - Resources : Adding sv-prep installation script + updating gridss, gripss, linx, and purple scripts
       aa742e3 Merged in release_4.3.2 (pull request #389)

  Gerardo Zapata Abogado <gerardo_za_94@hotmail.com>      52 commits

       7b7706d Merged in Gerardo_rnaseq_bigwig (pull request #390)
       ba3ce5c rnaseq_denovo [in silico] small fix of the base.ini
       36d1ac8 rnaseq.py [wiggle] _32 addition of strand2
       841e7af rnaseq.py [wiggle] _30 addition of strand
       2003ed7 rnaseq.py [wiggle] _30 bamcoverage to wiggle
       e7f2e49 rnaseq.py [wiggle] _29 added the addition of merged + forward + reverse - missing "s"
       354ffb0 rnaseq.py [wiggle] _29 added the addition of merged + forward + reverse
       99a979a readed deeptools.py
       eb2834d removed Deeptool.py
       4bf5bef rnaseq.py [wiggle] _28 small changes to .ini and .py
       2875008 rnaseq.py [wiggle] _27 small changes to .ini and .py
       36a123e rnaseq.py [wiggle] _26 small changes to .ini and .py
       a09aabd rnaseq.py [wiggle] _24 small changes to .ini and .py
       24279a3 rnaseq.py [wiggle] _24 small changes to .ini and .py
       12f3d6a rnaseq.py [wiggle] _22 small changes to .ini and .py
       39c1275 rnaseq.py [wiggle] _22 small changes to .ini and .py
       296ed2b rnaseq.py [wiggle] _21 small changes to .ini and .py
       4602dab rnaseq.py [wiggle] _20 changes to add option for for & rev.
       8a14901 rnaseq.py [wiggle] _19 need to implement changes to add option for for & rev.
       b56bbc0 rnaseq.py [wiggle] _18 location of ifelse loop
       3834821 rnaseq.py [wiggle] _17 set up option to run separate .bw??
       ecf6046 rnaseq.py [wiggle] Deeptools _16 add forward and reverse options
       7265f01 rnaseq.py [wiggle] Deeptools & Ini changes _15 small changes
       e2f2d55 rnaseq.py [wiggle] Deeptools - _14 string errors
       b46b26b rnaseq.py [raw_countMatrix] -  _12 for loop removal
       56ee874 rnaseq.py [raw_countMatrix] -  _11 bigwigs .zip
       d53d4f4 rnaseq.py [wiggle] - Deeptools _11 "missing comma" :|
       112882f rnaseq.py [wiggle] - Deeptools _11 "output_location error" + "archive"
       6cdd381 rnaseq.py [wiggle] - Deeptools _10 "name" "samplename" location
       4877bab rnaseq.py [wiggle] - Deeptools _9 "name" "samplename" location
       340669c rnaseq.py [wiggle] - Deeptools _8 missing comma
       35c2521 rnaseq.py [wiggle] - Deeptools _t "name" "samplename"
       218a978 rnaseq.py [wiggle] - Deeptools _6 missing comma
       a361eb1 rnaseq.py [wiggle] - Deeptools _5 "name" "samples"
       89a3e47 rnaseq.py - [wiggle] - concate_jobs
       ca916a9 rnaseq.py - fix Deeptools.bamCoverage()
       26b5869 Deeptools.py - fix bamCoverage
       9773382 rnaseq.py [wiggle] - Deeptools
       08e56f6 rnaseq.py [wiggle] - fix "tracks_directory"_4
       f5b8293 rnaseq.py [wiggle] - fix "tracks_directory"_3
       c2b03d9 rnaseq.py [wiggle] - fix "tracks_directory"_2
       91073b1 rnaseq.py [wiggle] - fix "tracks_directory"
       ed2f1c4 ranseq.py - added new wiggle step, removed previous
       0ae71bb rnaseq.py Modify [wiggle] ini
       bb9b912 Added - Deeptols.py
       fe825b1 rnaseq.py - readcounts - ".csv" to ".tsv" - ALL
       0bb883c rnaseq.py - rawCountMatrix - ".csv" to ".tsv" - ALL
       1b24722 rnaseq.py - readCounts - ".csv" to ".tsv" 2
       90bb9e2 rnaseq.py - readCounts - ".csv" to ".tsv"
       355a519 rnaseq.py - rawCountMatrix - ".csv" to ".tsv"
       0ed06e0 test commit Gerardo
       2b424a1 test commit

  mareike.janiak@computationalgenomics.ca <mareike.janiak@computationalgenomics.ca>      4 commits

       2121b4f methylseq : do not require methylation_protocol and mapping_implementation parameters to be set for hybrid protocol
       791aeb8 GenPipes methylseq : make single-pass dragen align option compatible with bismark in hybrid protocol
       b0507cf GenPipes - methylseq : fix cp from dragen
       2d69b61 issue caused by qiime_catenate loading two python modules

  Mareike Janiak <mareike.janiak@computationalgenomics.ca>      23 commits

       33a2685 Merged in cit_fixes_mcj (pull request #408)
       9e6f6e8 Rnaseq cancer : update genome version used for cpsr and pcgr
       a48b0ed Merged dev into cit_fixes_mcj
       a956760 Merged in cit_fixes_mcj (pull request #407)
       4cab100 gatk_indel_realigner : set -fixMisencodedQuals flag only when QualityOffsets are 64 (solexa/illumina1.5+)
       0e459ca skewer trimming : adjust trim settings based on quality offset in readset file
       b28269b Merge branch 'cit_fixes_mcj' of bitbucket.org:mugqic/genpipes into cit_fixes_mcj merge cit updates with local changes
       575d305 skewer trimming : adjust trimming settings based on quality offset provided in readset files
       8812822 Merged in EpiBrain_methylseq (pull request #406)
       2ab0e92 Merged in cit_fixes_mcj (pull request #405)
       1b9d47c Merged in EpiBrain_methylseq (pull request #404)
       ab58ff9 GenPipes - rnaseq : adding cd command to run_arriba
       5801352 removing outfile options from arriba
       3498227 Merged in cit_fixes_mcj (pull request #403)
       25f08c9 GenPipes arriba : added specific paths for arriba output files to run_arriba command
       33515ec GenPipes - rnaseq : removed -fixMisencodedQuals from ini for gatk_indel_realigner
       1ffffc2 GenPipes - rnaseq : fixed file extension in ini for run_arriba
       83f0d22 GenPipes - epiqc : add mkdir to chromimpute_convert
       2c6d4c7 Merged in ampliconseq_abacus_mcj (pull request #398)
       ce9f275 Merged in rnaseq_star_1pass (pull request #394)
       fae754e Merged dev into rnaseq_star_1pass
       cbfc765 Merged in tumor_pair_mcj (pull request #393)
       c9343cf Merged dev into rnaseq_star_1pass

  Mareike Janiak <mcj43@narval1.narval.calcul.quebec>      1 commits

       0522542 ability to skip 2-pass star alignment and only do 1 pass

  Mareike Janiak <mcj43@narval2.narval.calcul.quebec>      1 commits

       cd4a455 gatk_indel_realigner : added two cd commands
  ...
  Robert Eveleigh <robert.eveleigh@mcgill.ca>      1 commits
       ...
       638b81a Merged in rebase_rnaseq_variant (pull request #370)
...
4.3.2        Thu Dec 8 17:21:23 2022 +0000        132 commits
  ...
  Edouard Henrion <edouard.henrion@mcgill.ca>      54 commits
       ...
       ca99865 Merge remote-tracking branch 'origin/dev' into release_4.3.2
       118e25a GenPipes - Updating READMEs for release
       fdb289a Tumor Pair SV - properly setting the svaba indels vcf file in the config
       f568fe4 Tumor Pair - rearrangement of the ini for cit
       475e2b9 Tumor Pair SV - fixing metasv.ensemble call + fixed scones step for GRCh38
       eb7112e Tumor Pair SV - fixing step order
       16cd02b minor - replacing 'CentOS6' by 'root'
       53e3e05 Some more fixes induced by cit
       29e4697 RNASeq denovo asembly - fixed filter_annotated_components_exploratory
       c4d242b RNASeq denovo assembly - fixed differential expression steps
       77f4ca4 AmpliconSeq - enuring the use of Python2 for all the qiime commands
       143bc39 Tumor Pair Ensemble - fixed strelka dependencies to manta_indels
       ab56926 RNASeq - updated mugqic_tols to later dev version
       0aa6a1b DNASeq SV - updating cit.ini
       5c6358f DNASeq - corrected typo in gatk.py
       ba6439b RNASeq denov assembly - updated mugqic_tools to later dev version
       73a4da5 AmpliconSeq - setting mugqic_tools to later dev version
       7227a94 AmpliconSeq - some more formating
       93f057f RNASeq - correction of rnaseqc and htseq_count after cit
       2fdb99b AmpliconSeq - correctig job names
       152103b DNASeq SV - fix breaseq2 call
       8c73832 RNASeq - test batch effect corecction in DESeq2
       06a8eeb RNASeq - fixed typo
       b367867 RNASeq - fix after cit
       74bc420 HiCSeq - fix quality_scores afeter cit
       6ef0a21 DNASeq SV - fix svtyper after cit
       6f4cb2d pipelines/hicseq/hicseq.base.ini
       8264c71 DNASeq High Coverage - fix preprocess_vcf after cit
       7174d35 Ampliconseq - fix flash step after cit
       a008986 Tumor Pair - Fixing strlka dependencies to manta_sv
       d609411 RNASEQ + RNASeq Denovo : fixed batch corretion for RNASeq and added it to RNASeq denovo
       40cf403 Corrections after cit + formating
       185ed83 GenPipes - Fixes after cit on Béluga
       2bebb47 Fixes after cit + code standardization
       c9b9e2b DNASeq - SV : updating metasv module to 0.5.5
       b7d0ce4 DNASeq - SV : re-using delly VCF in meta_sv ensemble analysis, depending on meta_sv version
       3004136 DNASeq - SV : corrected manta_sv call by removing delly_vcf
       7c04440  DNASeq - correcting typo
       efa9aa3 DNASeq - correcting typo
       341de84 DNASeq - generalize use of self.output_dirs
       6775aad DNASeq - specify self.output_dir when setting files and folders path
       0284d9a DNAseq - SV : correcting ini sectino definition
       313dc00 BFX - correcting typo in `cpsr.py` and `htslib.py`
       224f3ea DNASeq - bug fixes for SV protocol
       48c925f DNASeq High Coverage - update sambamba_merge_sam_files in config
       ed1b33a Tumor Pair - format standardization
       3c82ce6 Tumor Pair - minor fix
       b21669d Tumor Pair - bfx/pcgr.py updated to fit with new version and keep backward conpatibility.
       e830d58 Tumor Pair - Report : updated with new version of PCGR (1.0.3) for both 'pcgr' and 'cpsr' reports
       c024bd6 DNASeq - corrected merge_sam_files + extract unmapped steps
       8279cfa Core - Scheduler : corredcted PBS mem-per-cpu settings when --force_mem_per_cpu
       a34fda4 Core - Scheduler : corrected `memory` call in `cpu` from dev
       4a045d5 Core - Scheduler : corrected `memory` call in `cpu`
       80afe6d Version bump to 4.3.1

  Édouard Henrion <henrione@beluga2.int.ets1.calculquebec.ca>      45 commits

       88e0ba8 CovSeq - Improving restart mechanisms
       a1ef935 ChIP-Seq - improved restart mechanisms
       962c90d AmpliconSeq - Improving the restart mechanisms
       aea76eb AmpliconSeq - Improving restart/resume mechanisms
       4e401e9 Tumor Pair SV - correcting svaba ref configuration
       d63c56d Tunmor Pair SV - CNV detection now done with cnvkit : removing SCoNes, not as well maintained as cnvkit.
       952693d Resources - corrected gridss install script
       3031bd6 DNASeq - returning to compressed filtered vcf for cnvkit
       705ace9 BFX - cnvkit : updated inputs in scatter and segment
       025165c CORE - removing useless log.debug() in core/pipeline.py
       29e81cc DNASeq SV - testing with no compression during cnvkit_batch.vcf_flt
       cefc1db Tunmor Pair - Fix cit ini
       b411c0c RNASeq light - correcting R version for kalisto differential expression
       b5e1d2e Tumor Pair - fixing cit ini
       5b440da Resources - put back DEV instead of wrongly modified GENFS
       ca57458 Modules - adding install script for tools needed in Tumor Pair SV
       7bc7fc3 DNASeq SV - corrected bcftools filtering before cnvkit + corrected metasv_ensemble command
       b67c4aa DNASeq SV - improved bcftools options for vcf filtering before cnvkit_batch
       8536530 DNASeq SV - corrected filtered vcf outputed by cnvkit_batch.vcf_flt
       ae84cc4 DNASeq SV - improved filetering in cnvkit_batch.vcf_flt
       56f73fd DNASeq + Tumor Pair - fixed breakseq2 wrapper
       4dd168e Core - Pipeline : corrected log.error to log.debug
       f8eaf1d Resources - updated mugqic_tools instalation script, adding java-tools in the module file
       be5efeb RNASeq denovo assembly - corrected outputs of edger and deseq2 jobs
       f6a7bb8 INI - updating mugqic_tools to latest production version for AmpliconSeq, RNASeq and RNASeq denovo assembly pipelines
       2b12dea DNASeq - correcting input dependencies for manta_sv jobs for better restart/resume of the pipeline
       c9493af RNASeq - refined ballgown job outputs to improved pipeline resume/restart mechanisms
       6300baf RNASeq - imporoved restart/resume mechanisms
       a5df32f DNASeq + Tumor Pair - imporoved restart/resume mechanisms
       1c7a63f AmpliconSeq - fixes  on python modules and restart mechanisms
       9b21440 RNASeq denovo assembly - correcting arguments in calls of py_parseMergeCsv
       fc88f6a DNASeq - bug fix
       1417bd8 Tools - correcting typo in bfx/tools.py
       096206b Config - corrected pipelines/common_ini/Homo_sapiens.GRCh38.ini
       4deb294 GenPipes - Config : reorganisation of the ini files contained within the repository
       a7883c1 GenPipes - config : use common_ini for GRCh38 specific config
       e784b35 GenPipes - DNASeq & Tumor Pair : cleaning ini files
       723b201 DNASeq SV - cleaning resources/genomes/config/Homo_sapiens.GRCh38.ini a bit...
       0b1e36a Resources - Adding some genome installation scripts
       b316c21 RNASeq denovo assembly - Corre ting calls to py_parseMergeCsv
       cadad22 AmpliconSeq - Correcting python call in qiime_otu_table
       9f3f3e7 Resources - adding some more module installation scripts
       20c0951 Install script - updates in module install scripts
       3341cbc Tumor Pair - Improving the restart mecanisms
       df5aa27 GenPipes - DEV : updating CHANGELOG and setting beta version

  ehenrion <edouard.henrion@mcgill.ca>      17 commits

       ed7c183 Merged in release_4.3.2 (pull request #388)
       23f764a GenPipes - Resources : updated mugqic_tools install script with latest version
       15091a0 DNASeq SV - updated pair_diretory path with non-absolute path
       b18b9d3 EPIQC - worked on file path to avoid depencencies errors and missing files
       5678259 HicSeq - stop uding mugqic_dev
       552c0fb RNASeq Light - fixing kallisto_count_matrix dependencies
       ee70b17 Tumor Pair SV - fix delly sv annotations dependencies
       71f9589 Tumor Pair SV - fixing SVannot call
       3e68d78 GenPipes - more formatting and linting
       90b9535 GenPipes - code cleaning and formating
       2dcd2e6 CoVSeQ - using report directory to output freebayes and ivar reports
       ef89a8f GenPipes - improved averall restart/resume mechanisims with relative path
       10727fe HicSeq - working on restart/resume mechanisms + doing some reformating
       ce5e36f Merged in tp_hotfix (pull request #385)
       03d0ab2 DNASeq - gnomad : corrected link to vcf
       118309c Merged in release_4.3.1 (pull request #383)
       baeee47 Merged in release_4.3.1 (pull request #382)

  Paul Stretenowich <paul.stretenowich@mcgill.ca>      16 commits

       0148c73 General - Linting
       dacf35a Merged in HotFix_dev (pull request #387)
       b9419c5 tumour_pair - artifacts_metrics - Fixing output file name for GenPipes to be able to skip step
       e799a37 covseq - sambamba_filtering - Adding SE options in ini file
       27b4f55 covseq - sambamba_filtering - Debug for SE mode
       cafd974 rnaseq_light - base ini - Updating mugqic_R_packages
       7ee0df6 Merged in bwa_sambamba_splitting (pull request #386)
       0182fc0 dnaseq_high_coverage - bwa_mem_sambamba_sort_sam - Adding bwa_mem_sambamba_sort_sam in ini
       5c2dccb dnaseq/tumour_pair - sambamba_sort - Minor improvement
       8b57df0 dnaseq/tumour_pair - sambamba_sort - deleting bai if existing and chmod the output bai
       1050404 dnaseq/tumour_pair - sambamba_sort - Removing index from sorting as the bai is generated by sorting
       506605f Merged in bwa_sambamba_splitting (pull request #384)
       656678d dnaseq/tumour_pair - base ini - Cleaning commented out code
       dd4ca69 dnaseq/tumour_pair - sambamba_sort_index - Fixing index input
       bef6394 dnaseq/tumour_pair - alignment - Switching in protocols
       2fceb10 dnaseq/tumour_pair - alignment - First commit
