...
if (DoSat == "1") {
	...
	mtext(paste("Saturation estimate of the mean FPKM - Excluding",as.character(fpkmZP),"perc of genes with fpkm = 0",sep=" "), side=3, line=1, cex=2, col="black")
        dev.off()
	...
	mtext(paste("Saturation estimate of the Percent Relative Error - Excluding",as.character(fpkmZP),"perc of genes with fpkm = 0",sep=" "), side=3, line=1, cex=2, col="black")
        dev.off()
    }
}
